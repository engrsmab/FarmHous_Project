...
class Main_Page(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.ticker_list = ['Root Water Uptake', 'Moisture Content', 'Salinity', 'Temperature', 'Humidity', "Sun Light"]

        # tickers to show on the plot
        self.tickers_on_plot = ['Root Water Uptake']
        ...
        self.good_handle_plot()

    def good_handle_plot(self ):
        mainview = ModalView(size_hint=(1, 1))
        ...
        leftbox = BoxLayout(orientation="vertical", size_hint_x=0.4)
        ...
        rightbox = BoxLayout(orientation="vertical",padding=5)
        ...
        rightbox.add_widget(
            backend.make_plot(self.plot_ratings, self.plot_dates, self.tickers_on_plot, self.plot_colors))
    ...
    def plot_make_legend(self):
        ...
        containing_box = BoxLayout(orientation="vertical", size_hint_y=0.5,size_hint_x=1.2, padding=10)
        ...
        for i in range(0, len(self.tickers_on_plot)):
            ...
            legend_grid.add_widget(
                Button(background_color=self.plot_colors[i], disabled=True, background_disabled_normal="",size_hint=(1,0.1)))
    ...
    def plot_cancel_ticker(self, ticker, mainview, instance):
        ...
        self.good_handle_plot()  # restart modalview, none replaces instance
